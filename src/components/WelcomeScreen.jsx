        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed inset-0 z-[99999] bg-slate-50 flex flex-col items-center justify-center font-bengali p-4 text-center"
                >
                    <motion.div
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            <h2 className="text-xl md:text-2xl font-black text-slate-800">আসসালামু আলাইকুম</h2>
                        ...
                        {/* Quranic Verse */}
                        <div className="mt-8 md:mt-12 bg-emerald-50 px-6 py-3 rounded-xl border border-emerald-100">
