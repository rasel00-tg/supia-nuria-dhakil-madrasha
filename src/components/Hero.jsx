            ...
            <div className="container relative z-10 px-4 flex flex-col items-center justify-center h-full pt-20 pb-10">
                ...
                <div className="space-y-3 max-w-full">
                    <motion.h1
                        ...
                        className="text-4xl sm:text-5xl md:text-5xl lg:text-7xl font-black text-white drop-shadow-2xl leading-tight font-bengali whitespace-normal md:whitespace-nowrap"
                    >
